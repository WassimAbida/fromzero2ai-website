...
from fromzero2ai.api_engine.errors.base import ErrorResponseCode, ErrorResponseContent, ErrorResponse
...
async def exception_handler(request: Request, exc: Exception) -> ErrorResponse:
    ...
    error_content = ErrorResponseContent(
        ErrorResponseCode.INTERNAL_SERVER_ERROR, message="Oops! something wrong happened."
    )
